...
def confirmation(verified_product, price_verified, quantity_verified, date_verified, brand_name_check):
    ...
    while True:
        if confirm.lower() == "a":
            if brand_name_check:
                new_product = Product(name=verified_product.title(), price=price_verified, quantity=quantity_verified,
                                      date_updated=date_verified, brand_id=brand_name_check.id)
            else:
                new_product = Product(name=verified_product.title(), price=price_verified, quantity=quantity_verified,
                                      date_updated=date_verified, brand_id=None)
